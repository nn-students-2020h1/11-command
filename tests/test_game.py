...
class TestGame(unittest.TestCase):
    ...
    def test_add_player(self):
        self.player = Player(game=self.game, is_human=True, name="John Doe")
    ...
    def test_next_turn(self):
        self.player_1 = Player(game=self.game, is_human=True, name="John Doe")
        self.player_2 = Player(game=self.game, is_human=False, name="Bot 1")
        self.player_3 = Player(game=self.game, is_human=False, name="Bot 2")
